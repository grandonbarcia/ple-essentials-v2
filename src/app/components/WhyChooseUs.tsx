...
export default function WhyChooseUse() {
  return (
    <section className="flex flex-col gap-16 w-full justify-center items-center pt-12 pb-12">
      ...
      <div className="flex flex-col md:flex-row w-2/3 justify-evenly items-center">
        <div className="grid gap-2 w-4/5 md:w-/4  text-center  pt-10 pb-10 px-5 rounded  z-20">
        ...
        <div className="grid gap-2 w-4/5 md:w-/4 text-center  pt-10 pb-10 px-5 rounded ">
